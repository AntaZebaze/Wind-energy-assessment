...
df = pd.read_csv('data/New true Datasets 10-09-2024/Train Datasets/Dataset 100m.csv')
...
torch.save(model.state_dict(), 'Code/100m/model/wind_speed_predictor.pth')
joblib.dump(scaler, 'Code/100m/model/scaler.joblib')
